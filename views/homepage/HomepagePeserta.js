...
export default function HomepagePeserta() {
    return (
        ...
        <div className="relative h-screen w-full flex flex-col items-center overflow-hidden bg-cover bg-center"
            style={{
                backgroundImage: "url('/Asset/Background Landscape.png')",
