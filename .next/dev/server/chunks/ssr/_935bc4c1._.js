...
function Register() {
    ...
    const handleProcessNext = async (e)=>{
        ...
        if (step === 0) {
            ...
            // FINAL SUBMIT KE BACKEND
            setLoading(true);
            try {
                // Lakukan pendaftaran untuk setiap tim dalam array (1 tim untuk Single, 3 tim untuk Bundle)
                for (const team of allTeamsData){
                    const payload = {
                        ...
                        bukti_pembayaran: "file_placeholder.png",
                        ...
                        members: team.members.map((m)=>({
                                ...
                                pas_foto: null,
                                kartu_pelajar: null,
                                bukti_follow_ceg: null,
                                bukti_follow_tkubaya: null
                            }))
                    };
                    // Memanggil API Service
                    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$core$2f$services$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"].register(payload);
                    if (!res.success) throw new Error(res.message || "Gagal mendaftarkan tim.");
                }
                setLoading(false);
                setSuccess(true);
            } catch (err) {
...
//# sourceMappingURL=_935bc4c1._.js.map