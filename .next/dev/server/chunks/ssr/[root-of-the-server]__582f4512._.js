...
const loginSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["object"]({
    nama: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["string"]().required("Nama harus diisi"),
    password: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["string"]().required("Password harus diisi")
});
...
function LoginPage() {
    ...
    const formik = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$formik$2f$dist$2f$formik$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useFormik"])({
        ...
        onSubmit: async (values)=>{
            ...
            const base64Credentials = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : '';
            const data = {
                nama: values.nama,
                password: values.password
            };
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$core$2f$services$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"].login(data, base64Credentials);
                const access_token = response?.data?.data?.token;
                const username = response?.data?.data?.nama_tim;
                const role = response?.data?.data?.role;
                if (access_token) {
                    dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$core$2f$feature$2f$token$2f$tokenSlice$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setToken"])({
                        token: access_token
                    }));
                    dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$core$2f$feature$2f$user$2f$userSlice$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setUser"])(username));
                    dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$core$2f$feature$2f$role$2f$roleSlice$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setRole"])(role));
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(`Selamat datang, ${username || 'User'}!`);
                    if (role === 'PESERTA') router.push('/');
                    else if (role === 'ADMIN') router.push('/admin');
                    else if (role === 'PENPOS') router.push('/pos');
                }
            } catch (error) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error?.response?.data?.message || 'Login gagal');
            }
        }
    });
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            touched.nama && errors.nama && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__582f4512._.js.map